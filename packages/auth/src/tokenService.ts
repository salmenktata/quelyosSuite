...
const logger = {
  error: (...args: unknown[]) => console.error('[TokenService]', ...args),
  warn: (...args: unknown[]) => console.warn('[TokenService]', ...args),
  info: (...args: unknown[]) => console.info('[TokenService]', ...args),
  debug: (...args: unknown[]) => console.debug('[TokenService]', ...args),
}
...
export type AuthEventType = 'login' | 'logout' | 'expired' | 'refreshed'
