  ...
  return (
    <Layout>
      <div className="![animation:none] p-4 md:p-8 space-y-6">
        ...
        <PageNotice config={financeNotices.expenses} className="![animation:none]" />
          ...
          <div className="![animation:none] bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
            <div className="![animation:none] flex items-center gap-3">
              <div className="![animation:none] p-3 bg-red-100 dark:bg-red-900/30 rounded-lg">
                <ArrowDownCircle className="![animation:none] h-6 w-6 text-red-600 dark:text-red-400" />
              </div>
              <div>
                <p className="![animation:none] text-sm text-gray-600 dark:text-gray-400">Total Dépenses</p>
        ...
        {isLoading ? (
          ...
          <div className="![animation:none] bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-12 text-center">
            <ArrowDownCircle className="![animation:none] h-16 w-16 text-gray-400 mx-auto mb-4" />
              ...
              <tbody className="![animation:none] bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                {filteredTransactions.map((tx) => (
                  <tr key={tx.id} className="![animation:none] hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td className="![animation:none] px-6 py-4 whitespace-nowrap text-right text-sm font-medium text-red-600 dark:text-red-400">
