      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Rejoignez Quelyos et profitez de tous nos avantages
          </p>
        </div>
        ...
        <div className="mt-8 bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="flex items-start gap-3 bg-gray-50 rounded-xl p-4">
              ...
              <div>
                <p className="font-semibold text-gray-900 mb-1">Suivi en temps réel</p>
                <p className="text-sm text-gray-600">Suivez vos commandes à chaque étape</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 bg-gray-50 rounded-xl p-4">
              ...
              <div>
                <p className="font-semibold text-gray-900 mb-1">Liste de souhaits</p>
                <p className="text-sm text-gray-600">Sauvegardez vos produits favoris</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 bg-gray-50 rounded-xl p-4">
              ...
              <div>
                <p className="font-semibold text-gray-900 mb-1">Offres exclusives</p>
                <p className="text-sm text-gray-600">Accédez aux promotions membres</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 bg-gray-50 rounded-xl p-4">
              ...
              <div>
                <p className="font-semibold text-gray-900 mb-1">Livraison rapide</p>
                <p className="text-sm text-gray-600">Livraison en 2-5 jours ouvrés</p>
              </div>
            </div>
          </div>
        </div>
