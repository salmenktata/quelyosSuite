        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {categories.slice(0, limit).map((category, index) => (
            ...
            >
              ...
              {category.image_url ? (
                <Image src={category.image_url} alt={category.name} width={300} height={200} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" style={{width: "auto", height: "auto"}} unoptimized />
              ) : (
                <div
