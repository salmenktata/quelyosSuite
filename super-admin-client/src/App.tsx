...
function App() {
  ...
  useEffect(() => {
    ...
    if (!isLoading && !isAuthenticated && !tokenService.isAuthenticated() && location.pathname !== '/login') {
  ...
  // Vérifier auth via state React OU tokenService (résout race condition après login)
