  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      if (!response.data.success || !response.data) {
        throw new Error(response.data.error || 'Failed to load attributes')
      }
...
export function useProductVariants(productId: number | undefined) {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      if (!response.data.success || !response.data) {
        throw new Error(response.data.error || 'Failed to load variants')
      }
      return {
  ...
  return useMutation({
    mutationFn: async (data: { attribute_id: number; value_ids: number[] }) => {
      ...
      if (!response.data.success) {
        throw new Error(response.data.error || 'Failed to add attribute')
      }
      return response
    },
    onSuccess: () => {
...
export function useUpdateProductVariant(productId: number | undefined) {
  ...
  return useMutation({
    mutationFn: async (data: {
      ...
      if (!response.data.success) {
        throw new Error(response.data.error || 'Failed to update variant')
      }
      return response
    },
    onSuccess: () => {
...
export function useUpdateVariantStock(productId: number | undefined) {
  ...
  return useMutation({
    mutationFn: async (data: { variant_id: number; quantity: number }) => {
      ...
      if (!response.data.success) {
        throw new Error(response.data.error || 'Failed to update variant stock')
      }
      return response
    },
    onSuccess: () => {
...
export function useRegenerateVariants(productId: number | undefined) {
  ...
  return useMutation({
    mutationFn: async () => {
      ...
      if (!response.data.success) {
        throw new Error(response.data.error || 'Failed to regenerate variants')
      }
