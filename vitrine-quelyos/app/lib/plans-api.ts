...
export const FALLBACK_PRICING_GRID: PricingGrid = {
  ...
  solutions: [
    { id: 'sol_restaurant', name: 'Quelyos Resto', slug: 'restaurant', price: 39, annualPrice: 30, description: 'Solution complète restauration', icon: 'UtensilsCrossed', color: 'orange', features: ['Point de Vente', 'Stock temps réel', 'Finance intégrée'], modules: ['pos', 'stock', 'finance'], modulesValue: 33, savings: 28 },
    ...
    { id: 'sol_ecommerce', name: 'Quelyos E-commerce', slug: 'ecommerce', price: 42, annualPrice: 33, description: 'E-commerce complet', icon: 'Globe', color: 'emerald', features: ['Boutique en ligne', 'Stock', 'Marketing', 'Finance'], modules: ['store', 'stock', 'marketing', 'finance'], modulesValue: 46, savings: 9 },
    { id: 'sol_services', name: 'Quelyos Services', slug: 'services', price: 29, annualPrice: 23, description: 'Entreprises de services', icon: 'Briefcase', color: 'violet', features: ['CRM', 'Support', 'Finance'], modules: ['crm', 'support', 'finance'], modulesValue: 26, savings: 10 },
    { id: 'sol_sante', name: 'Quelyos Santé', slug: 'sante', price: 19, annualPrice: 15, description: 'Cabinets & cliniques', icon: 'Heart', color: 'rose', features: ['Support (patients)', 'Finance'], modules: ['support', 'finance'], modulesValue: 14, savings: 26 },
    { id: 'sol_btp', name: 'Quelyos BTP', slug: 'btp', price: 29, annualPrice: 23, description: 'Bâtiment & construction', icon: 'HardHat', color: 'amber', features: ['GMAO', 'Stock', 'Finance'], modules: ['maintenance', 'stock', 'finance'], modulesValue: 27, savings: 7 },
    { id: 'sol_hotel', name: 'Quelyos Hôtel', slug: 'hotellerie', price: 32, annualPrice: 25, description: 'Hôtellerie & hébergement', icon: 'Hotel', color: 'teal', features: ['Support', 'GMAO', 'Finance', 'CRM'], modules: ['support', 'maintenance', 'finance', 'crm'], modulesValue: 35, savings: 9 },
    { id: 'sol_asso', name: 'Quelyos Asso', slug: 'associations', price: 15, annualPrice: 12, description: 'Associations & ONG', icon: 'HandHeart', color: 'sky', features: ['CRM (adhérents)', 'Finance'], modules: ['crm', 'finance'], modulesValue: 21, savings: 29 },
  ],
  userPacks: {
    size: 5,
    price: 15,
