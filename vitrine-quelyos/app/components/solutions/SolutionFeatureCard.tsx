...
export default function SolutionFeatureCard({ feature, className = "" }: SolutionFeatureCardProps) {
  return (
    ...
    >
      {/* Icon */}
      <div className="mb-4">
        <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-950/40 to-violet-950/40 text-3xl transition-transform group-hover:scale-110">
          {feature.icon}
        </div>
      </div>
      ...
      <div className="inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-emerald-950/30 to-teal-950/30 px-3 py-1.5 text-xs font-medium text-emerald-400">
