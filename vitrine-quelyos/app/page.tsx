              ...
              <div className="relative">
                ...
                <ul className="mb-8 space-y-3">
                  {[
                    {
                      icon: TrendingUp,
                      text: "Prévisions IA fiables à 85-90%",
                    },
              ...
              <div className="relative">
                ...
                <ul className="mb-8 space-y-3">
                  {[
                    ...
                    {
                      icon: Calendar,
                      text: "Publication automatique multi-réseaux",
                    },
                    {
                      icon: MessageSquare,
                      text: "Inbox unifiée + réponses IA",
                    },
                    {
                      icon: BarChart3,
                      text: "Analytics business & engagement",
                    },
                  ].map((feature, i) => (
                    <li
                      key={i}
                    ...
                    {[
                      {
                        ...
                        desc: "Capture omnicanale",
                      },
                      {
                        icon: Receipt,
                        text: "Facturation auto",
                        desc: "Devis & factures",
                      },
                      {
                        icon: Package,
        ...
        <Container>
          ...
          >
            ...
            <p className="mt-4 text-lg text-slate-400">
              Une suite pensée pour les TPE/PME qui veulent se concentrer sur
              leur métier
            </p>
          </m.div>
            ...
            {[
              {
                icon: Zap,
                title: "Simple & rapide",
                desc: "Prise en main en 10 minutes, pas besoin de formation",
                color: "text-yellow-400",
              },
              {
                icon: Shield,
                title: "Données sécurisées",
                desc: "Hébergement France, RGPD compliant, chiffrement",
              ...
              },
              {
                ...
                desc: "Tarifs adaptés TPE, pas d'engagement annuel",
        ...
        <Container narrow>
          ...
          >
            ...
            <p className="mx-auto mt-4 max-w-xl text-lg text-slate-300">
              Contactez-nous pour une démo gratuite ou commencez directement
