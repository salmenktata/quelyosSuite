...
const SECTOR_ID = 'education';

export const metadata: Metadata = {
  title: 'Quelyos Edu - Solution pour organismes de formation',
  description: 'Gérez inscriptions, conformité Qualiopi et facturation OPCO/CPF avec Quelyos Edu. Solution complète pour centres de formation et écoles.',
  keywords: ['solution formation', 'logiciel organisme formation', 'Qualiopi', 'gestion formation', 'facturation OPCO', 'ERP formation'],
  openGraph: {
    title: 'Quelyos Edu - Solution pour organismes de formation',
    description: 'Gérez inscriptions, conformité Qualiopi et facturation OPCO/CPF avec Quelyos Edu.',
    url: 'https://quelyos.com/solutions/education',
    type: 'website',
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: 'Quelyos Edu' }],
  },
  alternates: { canonical: 'https://quelyos.com/solutions/education' },
};

export default async function EducationSolutionPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      ...
      <PainPointsGrid
        ...
        title="Les défis de la formation"
      ...
      <FeaturesGrid
        ...
        subtitle="Les outils essentiels des organismes de formation qui réussissent"
      />

      <TestimonialsGrid
        testimonials={solution.testimonials}
        title="Ce que disent les organismes de formation"
        subtitle="Découvrez comment ils ont transformé leur gestion"
        className="bg-slate-50 dark:bg-slate-900/50"
      />
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-600 dark:text-slate-400">
              Rejoignez {solution.stats.clients} organismes de formation qui nous font confiance.
            </p>
            <div className="mt-10">
              <Link
