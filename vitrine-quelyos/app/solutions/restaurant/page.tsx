...
import {
  ArrowRight, Sparkles, UtensilsCrossed, Users, Clock, Brain,
  TrendingUp, ShoppingBag, Package, Wallet, Heart, Megaphone, Check
} from 'lucide-react';

const SECTOR_ID = 'restaurant';

export const metadata: Metadata = {
  title: 'Quelyos Resto - Solution complète pour restaurants',
  description: 'Pilotez votre restaurant avec sérénité. Commandes, stock, trésorerie : tout sous contrôle depuis une interface unifiée.',
  keywords: ['solution restaurant', 'gestion restaurant', 'logiciel restaurant', 'caisse restaurant', 'stock restaurant', 'trésorerie restaurant', 'POS restaurant', 'ERP restaurant'],
  openGraph: {
    title: 'Quelyos Resto - Solution complète pour restaurants',
    description: 'Pilotez votre restaurant avec sérénité. Commandes, stock, trésorerie : tout sous contrôle depuis une interface unifiée.',
    url: 'https://quelyos.com/solutions/restaurant',
    type: 'website',
    images: [
      {
        url: '/og-image.png',
        width: 1200,
        height: 630,
        alt: 'Quelyos Resto - Solution restaurant complète',
      },
    ],
  },
  alternates: {
    canonical: 'https://quelyos.com/solutions/restaurant',
  },
};
...
const processSteps = [
  { title: 'Prise de commande', description: 'Interface tactile intuitive. Commandes envoyées en cuisine instantanément, modifications en temps réel.', icon: '🍽️' },
  { title: 'Stock automatique', description: 'Chaque commande décrémente le stock. Alertes automatiques quand un ingrédient passe sous le seuil.', icon: '📦' },
  { title: 'Trésorerie en temps réel', description: 'Chaque encaissement alimente vos tableaux financiers. Marge brute, CA par service, tout est calculé.', icon: '💰' },
  { title: 'Fidélisation client', description: 'Points de fidélité, campagnes SMS/email ciblées, historique des préférences pour un service personnalisé.', icon: '⭐' },
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-indigo-950/20 to-slate-950">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-indigo-500/30 bg-indigo-500/10 px-4 py-2 backdrop-blur-sm">
              ...
              <span className="text-sm font-medium text-indigo-300">Solution Restauration Complète</span>
            </div>

            {/* Title */}
            <h1 className="text-4xl font-bold tracking-tight sm:text-6xl lg:text-7xl">
              <span className="text-white">Pilotez votre </span>
              <span className="bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">restaurant</span>
              <span className="text-white"> avec sérénité</span>
            </h1>
            ...
            <div className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Link
                href="/contact?utm_source=solution&utm_package=restaurant"
                className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-indigo-500 to-indigo-600 px-8 py-3.5 text-sm font-semibold text-white shadow-lg shadow-indigo-500/25 transition hover:shadow-indigo-500/40"
              >
              ...
              <Link
                href="/tarifs"
                className="inline-flex items-center gap-2 rounded-xl border border-white/20 bg-white/5 px-8 py-3.5 text-sm font-semibold text-white backdrop-blur-sm transition hover:bg-white/10"
              >
                Voir les tarifs
              </Link>
            </div>
      ...
      <PainPointsGrid
        ...
        title="Les défis de la restauration"
      ...
      <FeaturesGrid
        ...
        subtitle="Les outils essentiels des restaurateurs qui réussissent"
      />
      ...
      <ProcessMetier
        ...
        subtitle="De la commande à la fidélisation, un flux entièrement automatisé"
        className="bg-slate-950/50"
      />
      ...
      <TestimonialsGrid
        ...
        title={`Ce que disent les ${solution.sectorName.toLowerCase()}`}
        subtitle="Découvrez comment ils ont transformé leur restaurant"
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl rounded-3xl border border-indigo-500/20 bg-gradient-to-br from-indigo-950/50 to-violet-950/50 p-12 text-center backdrop-blur-sm sm:p-16">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">
              Prêt à transformer votre {solution.sectorName.toLowerCase()} ?
            </h2>
            <p className="mt-6 text-lg leading-8 text-slate-300">
              Rejoignez {solution.stats.clients} restaurateurs qui nous font confiance.
            </p>
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Link
                href="/contact?utm_source=solution-cta&utm_package=restaurant"
                className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-indigo-500 to-indigo-600 px-8 py-3.5 text-sm font-semibold text-white shadow-lg shadow-indigo-500/25 transition hover:shadow-indigo-500/40"
              >
                Demander une démonstration
                <ArrowRight className="h-4 w-4" />
