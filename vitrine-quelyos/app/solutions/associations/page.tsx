...
import {
  ArrowRight, Sparkles, Heart, Users, Clock, Brain,
  TrendingUp, UserPlus, Wallet, Megaphone, CalendarDays, Check
} from 'lucide-react';
...
const modules = [
  { icon: UserPlus, label: 'Adhérents', color: 'text-indigo-400' },
  { icon: Wallet, label: 'Cotisations', color: 'text-emerald-400' },
  { icon: CalendarDays, label: 'Événements', color: 'text-amber-400' },
  { icon: Megaphone, label: 'Communication', color: 'text-pink-400' },
  { icon: Heart, label: 'Bénévoles', color: 'text-violet-400' },
];

const processSteps = [
  { title: 'Inscription adhérent', description: 'Formulaire en ligne, validation automatique, fiche membre créée instantanément dans votre base.', icon: '📋' },
  { title: 'Cotisation automatique', description: 'Prélèvement, relances automatiques, reçus fiscaux générés. Zéro suivi manuel.', icon: '💳' },
  { title: 'Communication ciblée', description: 'Newsletters, SMS, notifications par groupe ou statut. Touchez les bonnes personnes au bon moment.', icon: '📨' },
  { title: 'Événements & bilan', description: 'Inscriptions en ligne, gestion des places, bilan financier automatique après chaque événement.', icon: '🎉' },
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-indigo-950/20 to-slate-950">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-indigo-500/30 bg-indigo-500/10 px-4 py-2 backdrop-blur-sm">
              ...
              <span className="text-sm font-medium text-indigo-300">Solution Associative Complète</span>
            </div>

            <h1 className="text-4xl font-bold tracking-tight sm:text-6xl lg:text-7xl">
              <span className="text-white">Animez votre </span>
              <span className="bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">association</span>
              <span className="text-white"> sans complexité</span>
            </h1>
      ...
      <PainPointsGrid
        ...
        title="Les défis des associations"
      ...
      <FeaturesGrid
        ...
        subtitle="Les outils essentiels des responsables associatifs"
      />

      <ProcessMetier
        steps={processSteps}
        title="Comment ça fonctionne au quotidien"
        subtitle="De l'inscription à l'événement, un flux entièrement automatisé"
        className="bg-slate-950/50"
      />
      ...
      <TestimonialsGrid
        ...
        subtitle="Découvrez comment ils ont transformé leur association"
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl rounded-3xl border border-indigo-500/20 bg-gradient-to-br from-indigo-950/50 to-violet-950/50 p-12 text-center backdrop-blur-sm sm:p-16">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">
              Prêt à dynamiser votre association ?
            </h2>
            <p className="mt-6 text-lg leading-8 text-slate-300">
              Rejoignez {solution.stats.clients} associations qui nous font confiance.
            </p>
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              ...
              <Link href="/tarifs" className="inline-flex items-center gap-2 rounded-xl border border-white/20 bg-white/5 px-8 py-3.5 text-sm font-semibold text-white backdrop-blur-sm transition hover:bg-white/10">
                Voir les tarifs
              </Link>
            </div>
          </div>
