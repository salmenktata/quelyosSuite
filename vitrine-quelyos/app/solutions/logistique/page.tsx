...
const SECTOR_ID = 'logistique';

export const metadata: Metadata = {
  title: 'Quelyos Logistique - Solution transport et entreposage',
  description: 'Optimisez vos flux logistiques avec Quelyos Logistique. Gestion entrepôts, maintenance flotte, pilotage financier et CRM pour transporteurs.',
  keywords: ['solution logistique', 'gestion transport', 'WMS', 'maintenance flotte', 'logiciel logistique', 'ERP transport'],
  openGraph: {
    title: 'Quelyos Logistique - Solution transport et entreposage',
    description: 'Optimisez vos flux logistiques avec Quelyos Logistique.',
    url: 'https://quelyos.com/solutions/logistique',
    type: 'website',
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: 'Quelyos Logistique' }],
  },
  alternates: { canonical: 'https://quelyos.com/solutions/logistique' },
};

export default async function LogistiqueSolutionPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      ...
      <PainPointsGrid
        ...
        title="Les défis de la logistique"
      ...
      <FeaturesGrid
        ...
        subtitle="Les outils essentiels des logisticiens qui réussissent"
      />

      <TestimonialsGrid
        testimonials={solution.testimonials}
        title="Ce que disent les professionnels de la logistique"
        subtitle="Découvrez comment ils ont optimisé leurs opérations"
        className="bg-slate-50 dark:bg-slate-900/50"
      />
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-600 dark:text-slate-400">
              Rejoignez {solution.stats.clients} professionnels qui nous font confiance.
            </p>
            <div className="mt-10">
              <Link
