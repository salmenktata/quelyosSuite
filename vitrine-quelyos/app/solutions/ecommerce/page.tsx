        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-4">
              <Link href="/contact?utm_source=solution&utm_package=ecommerce" className="rounded-lg bg-indigo-600 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500">Demander une démonstration</Link>
            ...
            <p className="mt-6 text-sm text-slate-500">Essai gratuit 30 jours • Sans engagement</p>
          </div>
        </div>
      </section>
      <PainPointsGrid painPoints={solution.painPoints} title="Les défis de l'e-commerce" className="bg-slate-50 dark:bg-slate-900/50" />
      <FeaturesGrid features={solution.features} title={`Tout ce qu'il faut pour ${solution.verb}`} />
      <TestimonialsGrid testimonials={solution.testimonials} title="Ce que disent les e-commerçants" className="bg-slate-50 dark:bg-slate-900/50" />
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center"><h2 className="text-3xl font-bold text-slate-900 dark:text-white sm:text-4xl">Tarif {solution.name}</h2></div>
