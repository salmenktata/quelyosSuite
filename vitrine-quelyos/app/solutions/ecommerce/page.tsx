  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      ...
      <PainPointsGrid
        ...
        title={`Les défis de l'e-commerce`}
      ...
      <FeaturesGrid
        ...
        subtitle="Les outils essentiels des e-commerçants qui réussissent"
      />

      <TestimonialsGrid
        testimonials={solution.testimonials}
        title="Ce que disent les e-commerçants"
        subtitle="Découvrez comment ils ont transformé leur boutique en ligne"
        className="bg-slate-50 dark:bg-slate-900/50"
      />
      ...
      <section className="py-20 bg-gradient-to-br from-indigo-50 to-violet-50 dark:from-indigo-950/30 dark:to-violet-950/30">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-4xl">
              Prêt à booster vos ventes en ligne ?
            </h2>
            <p className="mt-6 text-lg leading-8 text-slate-600 dark:text-slate-400">
              Rejoignez {solution.stats.clients} e-commerçants qui nous font confiance.
            </p>
            <div className="mt-10">
              <Link
