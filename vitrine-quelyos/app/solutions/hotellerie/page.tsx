  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-10 grid grid-cols-2 gap-4 sm:grid-cols-4">
              {[
                { label: 'Clients', value: solution.stats.clients },
                { label: 'Temps gagné', value: solution.stats.timeSaved },
                { label: 'Précision IA', value: solution.stats.precision },
                { label: 'ROI moyen', value: solution.stats.mainMetric },
              ].map((stat, i) => (
      ...
      <PainPointsGrid
        ...
        title={`Les défis de l'hôtellerie`}
      ...
      <FeaturesGrid
        ...
        subtitle={`Les outils essentiels des professionnels de l'hôtellerie`}
      />

      <TestimonialsGrid
        testimonials={solution.testimonials}
        title={`Ce que disent les ${solution.sectorName.toLowerCase()}`}
        subtitle="Découvrez comment ils ont transformé leur établissement"
        className="bg-slate-50 dark:bg-slate-900/50"
      />
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-600 dark:text-slate-400">
              Rejoignez {solution.stats.clients} hôteliers qui nous font confiance.
            </p>
            <div className="mt-10">
              <Link
