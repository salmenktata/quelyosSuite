      ...
      <section className="relative overflow-hidden py-20 sm:py-32">
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-10"><Link href="/contact?utm_source=solution&utm_package=hotellerie" className="rounded-lg bg-indigo-600 px-6 py-3 text-sm font-semibold text-white hover:bg-indigo-500">Demander une démonstration</Link></div>
          </div>
        </div>
      </section>
